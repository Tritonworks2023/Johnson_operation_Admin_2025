...
import { AudiUserComponent } from "./pages/audi-user/audi-user.component";
import { AudiViewActivityComponent } from "./pages/audi-view-activity/audi-view-activity.component";
...
import { JoininspectionRecalComponent } from "./pages/joininspection-recal/joininspection-recal.component";
import { JointinspectPdfComponent } from "./pages/jointinspect-pdf/jointinspect-pdf.component";
...
const routes: Routes = [
  ...
  {
    path: "singledataentry_detail/:id",
    component: SingleDataentryDetailComponent,
  },
  ...
  {
    path: "joininspection_details",
    component: JoininspectionJobDetailsComponent,
  },
  {
    path: "joininspection_job_list",
    component: JoininspectionJobListComponent,
  },
  {
    path: "joininspection_job_sub_group_list",
    component: JoininspectionJobSubGroupListComponent,
  },
  { path: "joininspection_details_pdf", component: JointinspectPdfComponent },

  { path: "audit_user", component: AudiUserComponent },

  { path: "audi_view_activity", component: AudiViewActivityComponent },
  ...
  { path: "adho_training_time_sheet", component: AdhoTrainingTimeSheetComponent },
];
