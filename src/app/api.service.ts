...
export class ApiService {
  ...
  service_delete(data) {
    return this.http.post(
      this.apiUrl + "service_management/admin_delete",
      data
    );
  }
  ...
  Field_list_by_group(data) {
    return this.http.post(
      this.apiUrl + "field_management/getlist_by_group_id",
      data
    );
  }
  ...
  Field_list_by_sub_group(data) {
    return this.http.post(
      this.apiUrl + "field_management/getlist_by_sub_group_id",
      data
    );
  }
  ...
  activedetail_delete(data) {
    return this.http.post(
      this.apiUrl + "activedetail_management/admin_delete",
      data
    );
  }
  activedetail_filter_date(data) {
    return this.http.post(
      this.apiUrl + "activedetail_management/filter_date",
      data
    );
  }
  ...
  groupdetail_delete(data) {
    return this.http.post(
      this.apiUrl + "group_detail_managment/admin_delete",
      data
    );
  }
  groupdetail_filter_date(data) {
    return this.http.post(
      this.apiUrl + "group_detail_managment/filter_date",
      data
    );
  }
  ...
  groupdetail_fetch_by_id(data) {
    return this.http.post(
      this.apiUrl + "group_detail_managment/fetch_by_id",
      data
    );
  }
  ...
  groupdetail_list_subgroup() {
    return this.http.get(
      this.apiUrl + "new_group_detail_managment/groupdetail_list_subgroup1"
    );
  }
  ...
  sub_groupdetail_insert(data) {
    return this.http.post(
      this.apiUrl + "sub_group_detail_managment/create",
      data
    );
  }
  sub_groupdetail_edit(data) {
    return this.http.post(
      this.apiUrl + "sub_group_detail_managment/edit",
      data
    );
  }
  sub_groupdetail_delete(data) {
    return this.http.post(
      this.apiUrl + "sub_group_detail_managment/admin_delete",
      data
    );
  }
  sub_groupdetail_filter_date(data) {
    return this.http.post(
      this.apiUrl + "sub_group_detail_managment/filter_date",
      data
    );
  }
  ...
  sub_groupdetail_fetch_by_id(data) {
    return this.http.post(
      this.apiUrl + "sub_group_detail_managment/fetch_by_id",
      data
    );
  }
  ...
  fetch_entry_detail_list(data) {
    return this.http.post(
      this.apiUrl + "data_store_management/fetch_data",
      data
    );
  }
  ...
  entry_detail_delete(data) {
    return this.http.post(
      this.apiUrl + "data_store_management/admin_delete",
      data
    );
  }
  ...
  fetch_entry_detail_activity_list(data) {
    return this.http.post(
      this.apiUrl + "data_store_management/activity_list",
      data
    );
  }

  fetch_data_admin(data) {
    return this.http.post(
      this.apiUrl + "data_store_management/fetch_data_admin",
      data
    );
  }

  fetch_data_admin_form2(data) {
    return this.http.post(
      this.apiUrl + "data_store_management/fetch_data_admin_form2",
      data
    );
  }

  fetch_address(data) {
    return this.http.post(this.apiUrl + "job_no_managment/fetch_address", data);
  }
  ...
  fetch_userdetail(data) {
    return this.http.post(
      this.apiUrl + "user_management/getlist_fetch_id",
      data
    );
  }
  ...
  audit_getlist_userdetail() {
    return this.http.get(this.apiUrl + "audit_user_management/getlist");
  }
  audit_userdetail_insert(data) {
    return this.http.post(this.apiUrl + "audit_user_management/create", data);
  }
  audit_userdetail_edit(data) {
    return this.http.post(this.apiUrl + "audit_user_management/edit", data);
  }
  audit_userdetail_delete(data) {
    return this.http.post(
      this.apiUrl + "audit_user_management/admin_delete",
      data
    );
  }
  audit_userdetail_filter_date(data) {
    return this.http.post(
      this.apiUrl + "audit_user_management/filter_date",
      data
    );
  }

  audit_userdetail_login(data) {
    return this.http.post(
      this.apiUrl + "audit_user_management/mobile/login_page",
      data
    );
  }
  ...
  Joint_inspection_jobdetail_fetch_by_job(data) {
    return this.http.post(this.apiUrl + "joininspection/fetch_by_job", data);
  }

  Joint_inspection_jobdetail_sub_group_list(data) {
    return this.http.post(
      this.apiUrl + "joininspection/getlist_subgroup_list",
      data
    );
  }
  ...
  fetch_data_activity() {
    return this.http.get(
      this.apiUrl + "new_group_detail_managment/fetch_data_activity"
    );
  }

  Joint_inspection_jobdetail_list_two() {
    return this.http.get(this.apiUrl + "joininspection/getlist_two");
  }

  update_join_key_data(data) {
    return this.http.post(this.apiUrl + "joininspection/update_status", data);
  }

  pull_and_upload_datas(data) {
    return this.http.post(
      this.apiUrl + "new_group_detail_managment/pull_and_upload_datas",
      data
    );
  }
  ...
  new_groupdetail_insert(data) {
    return this.http.post(
      this.apiUrl + "new_group_detail_managment/create",
      data
    );
  }
  new_groupdetail_edit(data) {
    return this.http.post(
      this.apiUrl + "new_group_detail_managment/edit",
      data
    );
  }
  new_groupdetail_delete(data) {
    return this.http.post(
      this.apiUrl + "new_group_detail_managment/admin_delete",
      data
    );
  }
  new_groupdetail_filter_date(data) {
    return this.http.post(
      this.apiUrl + "new_group_detail_managment/filter_date",
      data
    );
  }
  ...
  new_groupdetail_fetch_by_id(data) {
    return this.http.post(
      this.apiUrl + "new_group_detail_managment/fetch_by_id",
      data
    );
  }
  new_groupdetail_rearrange() {
    return this.http.get(
      this.apiUrl + "new_group_detail_managment/reload_data"
    );
  }

  new_groupdetail_list_subgroup() {
    return this.http.get(
      this.apiUrl + "new_group_detail_managment/groupdetail_list_subgroup"
    );
  }
  ...
  service_employee_activity(data) {
    return this.http.post(
      this.apiUrl + "service_employee_activity_allocation/create",
      data
    );
  }
  service_employee_activity_delete(data) {
    return this.http.post(
      this.apiUrl + "service_employee_activity_allocation/delete",
      data
    );
  }
  service_employee_activity_getlist(data) {
    return this.http.post(
      this.apiUrl + "service_employee_activity_allocation/fetch_allocation",
      data
    );
  }
  //location mapping
  ...
  breakdown_data_details(data) {
    return this.http.post(
      this.apiUrl + "breakdown_data_management/fetch_job_id",
      data
    );
  }
  ...
  fetch_iso_number(data) {
    return this.http.post(
      this.apiUrl + "service_userdetails/fetch_iso_number",
      data
    );
  }
  ...
  fetch_branch_address(data) {
    return this.http.post(
      this.apiUrl + "service_userdetails/fetch_branch_address",
      data
    );
  }
  ...
  fetch_breakdown_job_detail(data) {
    return this.http.post(
      this.apiUrl + "service_userdetails/fetch_breakdown_job_detail",
      data
    );
  }

  fetch_area_breakdown(data) {
    return this.http.post(
      this.apiUrl + "service_userdetails/fetch_area_breakdown",
      data
    );
  }
  ...
  error_log_with_job_no(data) {
    return this.http.post(
      this.apiUrl + "activity/check_error_log_job_no",
      data
    );
  }

  liftwell_data_delete(data) {
    return this.http.post(this.apiUrl + "activity/delete_lift_well_data", data);
  }

  liftwell_data_delete_error_log(data) {
    return this.http.post(
      this.apiUrl + "activity/check_error_log_job_no_delete",
      data
    );
  }
  ...
  clear_employee_deviceId() {
    return this.http.get(
      this.apiUrl + "user_management/operationUserClearDeviceID"
    );
  }

  clear_device_id_by_number(data) {
    return this.http.post(
      this.apiUrl + "user_management/clear_device_id_by_number",
      data
    );
  }
  ...
  time_sheet(data) {
    return this.http.post(
      this.apiUrl + "operation-timesheet/getTimeSheetForAdmin",
      data
    );
  }
  // Back Navigation
